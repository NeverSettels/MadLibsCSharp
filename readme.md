...
_This console application will allow the user to play MadLibs_

_This application sets up a C# environment that uses Views & uses .NET Core Sdk 2.2_
...
WiseFool92.github.io/MadLibsCSharp
...
Copyright (c) 2020 **_Nathan Watkins-Hoagland & Erik Settels_**
